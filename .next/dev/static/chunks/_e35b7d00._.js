...
const NavBar = ()=>{
    ...
    if ($[0] !== "334cdcdf6a616a6b196e20228d30680f9442cd5522e6e87f87c416ac8814f1db") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "334cdcdf6a616a6b196e20228d30680f9442cd5522e6e87f87c416ac8814f1db";
    }
    ...
    const scrollToBottom = _temp;
    const t2 = `fixed top-0 z-100 transition-colors duration-300 ${isSolid ? "bg-gray-900" : "bg-transparent"} min-w-screen`;
    let t3;
...
_s(NavBar, "S5pIZWjPi1lzAP1ortd13/G3G0c=");
_c = NavBar;
...
//# sourceMappingURL=_e35b7d00._.js.map